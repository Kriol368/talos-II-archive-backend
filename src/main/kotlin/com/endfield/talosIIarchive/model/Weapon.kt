...
data class Weapon(
    ...
    @Column(name = "base_atk", nullable = false) val baseAtk: Int,

    @Column(name = "stat_1", length = 100) val stat1: String? = null,

    @Column(name = "stat_2", length = 100) val stat2: String? = null,

    @Column(nullable = false, columnDefinition = "TEXT") val passive: String
)